...
Date accepted             YYYY-MM-DD (or YYYY-MM-DD HH:MM)    yes, optional     no                yes, optional, saves empty values
Date published            YYYY-MM-DD (or YYYY-MM-DD HH:MM)    yes, optional     no                yes, optional, saves empty values
...
Issue pub date            YYYY-MM-DD (or YYYY-MM-DD HH:MM)    yes, required     yes               yes, required
========================= =================================== ================= ================= =====================================
